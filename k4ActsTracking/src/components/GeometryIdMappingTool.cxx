...
const det_mod_map GeometryIdMappingTool::NLad_VertexBarrel = {
    {GeometryIdMappingTool::DetSchema::MuColl_v1, {{0, 5}, {1, 5}, {2, 5}, {3, 5}, {4, 5}, {5, 5}, {6, 5}, {7, 5}}},
    {GeometryIdMappingTool::DetSchema::MAIA_v0, {{0, 5}, {1, 5}, {2, 5}, {3, 5}, {4, 5}}},
    {GeometryIdMappingTool::DetSchema::MuSIC_v1, {{0, 5}, {2, 5}, {4, 5}, {6, 5}}},
    {GeometryIdMappingTool::DetSchema::MuSIC_v2, {{0, 5}, {2, 5}, {4, 5}, {6, 5}, {8, 5}}},
};
...
const det_mod_map GeometryIdMappingTool::NRng_VertexEndCap = {
    ...
    {GeometryIdMappingTool::DetSchema::MAIA_v0,
     {{0, 16}, {1, 16}, {2, 16}, {3, 16}, {4, 16}, {5, 16}, {6, 16}, {7, 16}}},
    {GeometryIdMappingTool::DetSchema::MuSIC_v1, {{0, 16}, {2, 16}, {4, 16}, {6, 16}}},
    {GeometryIdMappingTool::DetSchema::MuSIC_v2, {{0, 16}, {2, 16}, {4, 16}, {6, 16}}}};
...
const det_mod_map GeometryIdMappingTool::NRng_OuterInnerTrackerEndCap = {
    {GeometryIdMappingTool::DetSchema::MuColl_v1, {{1, 26}, {2, 26}, {3, 26}, {4, 26}, {5, 26}, {6, 26}}},
    {GeometryIdMappingTool::DetSchema::MAIA_v0, {{1, 26}, {2, 26}, {3, 26}, {4, 26}, {5, 26}, {6, 26}}},
    {GeometryIdMappingTool::DetSchema::MuSIC_v1, {{1, 26}, {2, 26}, {3, 26}, {4, 26}, {5, 26}, {6, 26}}},
    {GeometryIdMappingTool::DetSchema::MuSIC_v2, {{1, 26}, {2, 26}, {3, 26}, {4, 26}, {5, 26}, {6, 26}}}};

const det_mod_map GeometryIdMappingTool::NLad_OuterTrackerBarrel = {
    {GeometryIdMappingTool::DetSchema::MuColl_v1, {{0, 84}, {1, 84}, {2, 84}}},
    {GeometryIdMappingTool::DetSchema::MAIA_v0, {{0, 84}, {1, 84}, {2, 84}}},
    {GeometryIdMappingTool::DetSchema::MuSIC_v1, {{0, 84}, {1, 84}, {2, 84}}},
    {GeometryIdMappingTool::DetSchema::MuSIC_v2, {{0, 84}, {1, 84}, {2, 84}}}};
...
Acts::GeometryIdentifier GeometryIdMappingTool::getGeometryID(const edm4hep::SimTrackerHit& hit) const {
  // Decode Cell ID
...
Acts::GeometryIdentifier GeometryIdMappingTool::getGeometryID(const edm4hep::TrackerHitPlane& hit) const {
  return GeometryIdMappingTool::getGeometryIDTrack(hit.getCellID());
}

Acts::GeometryIdentifier GeometryIdMappingTool::getGeometryID(const edm4hep::TrackerHit& hit) const {
  return GeometryIdMappingTool::getGeometryIDTrack(hit.getCellID());
}

Acts::GeometryIdentifier GeometryIdMappingTool::getGeometryIDTrack(uint64_t cellID) const {
  // Encode ACTS ID
  return getGeometryID(m_decoder.get(cellID, m_systemIdx), m_decoder.get(cellID, m_layerIdx),
                       m_decoder.get(cellID, m_sideIdx), m_decoder.get(cellID, m_moduleIdx),
                       m_decoder.get(cellID, m_sensorIdx));
...
Acts::GeometryIdentifier GeometryIdMappingTool::getGeometryID(uint32_t systemID, uint32_t layerID, int32_t sideID,
  ...
  switch (signSystemID) {
    ...
    case VertexBarrel:
      layer_id = layerID + 2;
      if (det_type == GeometryIdMappingTool::DetSchema::MuColl_v1)
  ...
  switch (signSystemID) {
    ...
    case InnerTrackerBarrel:
      sensitive_id = NLad_InnerTrackerBarrel.at(det_type).at(layerID) * ladderID + moduleID + 1;
      break;
    case OuterInnerTrackerBarrel:
      sensitive_id = NLad_OuterInnerTrackerBarrel.at(det_type).at(layerID) * ladderID + moduleID + 1;
      break;
    case OuterTrackerBarrel:
      sensitive_id = NLad_OuterTrackerBarrel.at(det_type).at(layerID) * ladderID + moduleID + 1;
      break;
    ...
    case InnerTrackerEndCapNegative:
    case InnerTrackerEndCapPositive:
      sensitive_id = NRng_InnerTrackerEndCap.at(det_type).at(layerID) * ladderID + moduleID + 1;
      break;

    case OuterInnerTrackerEndCapNegative:
    case OuterInnerTrackerEndCapPositive:
      sensitive_id = NRng_OuterInnerTrackerEndCap.at(det_type).at(layerID) * ladderID + moduleID + 1;
      break;

    case OuterTrackerEndCapNegative:
    case OuterTrackerEndCapPositive:
      sensitive_id = NRng_OuterTrackerEndCap.at(det_type).at(layerID) * ladderID + moduleID + 1;
      break;
